...
Current scope is defined in [CONSTRAINTS.md](CONSTRAINTS.md) and [METHODOLOGY.md](METHODOLOGY.md). The completed checklist below is historical and retains the settings of its original run.

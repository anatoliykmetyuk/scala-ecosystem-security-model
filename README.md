...
The completed cache-backed pilot and its coverage limitations are documented in **[EXPANDED-RUN.md](docs/EXPANDED-RUN.md)**. Its local report is `output/preview.html`.
